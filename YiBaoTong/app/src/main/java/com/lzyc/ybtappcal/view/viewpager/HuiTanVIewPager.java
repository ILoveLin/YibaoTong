 ...
 */
public class HuiTanVIewPager extends ViewPager {
    ...
    public HuiTanVIewPager(Context context) {
        super(context);
    }

    public HuiTanVIewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
