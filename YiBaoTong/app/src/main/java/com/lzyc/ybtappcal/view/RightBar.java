...
public class RightBar extends View {
	...
	public RightBar(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(context);
	}

	public RightBar(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
	...
	private void init(Context context){
		...
		paint.setTextSize(context.getResources().getDimension(R.dimen.text_font_13));
