...
//            v.setPadding((int) mTabPadding, v.getPaddingTop(), (int) mTabPadding, v.getPaddingBottom());
            ...
            if (tv_tab_title != null) {
                ...
                tv_tab_title.setTextSize(TypedValue.COMPLEX_UNIT_PX, mTextsize);//源码
                tv_tab_title.setTextSize(i == mCurrentTab ? 16 : 15);//选中的tab字体大小 ：未选中字体大小
    ...
    private void updateTabSelection(int position) {
        for (int i = 0; i < mTabCount; ++i) {
            ...
            if (tab_title != null) {
                ...
                tab_title.setTextSize(isSelect ? 16 : 15);
