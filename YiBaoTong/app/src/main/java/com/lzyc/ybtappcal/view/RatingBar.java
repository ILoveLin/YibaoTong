...
public class RatingBar extends LinearLayout {
    ...
    public RatingBar(Context context, AttributeSet attrs) {
        ...
        this.starImageSize = mTypedArray.getDimension(R.styleable.RatingBar_RatingBarstarImageSize, 20.0F);
        this.starCount = mTypedArray.getInteger(R.styleable.RatingBar_RatingBarstarCount, 5);
        this.starEmptyDrawable = mTypedArray.getDrawable(R.styleable.RatingBar_RatingBarstarEmpty);
        this.starFillDrawable = mTypedArray.getDrawable(R.styleable.RatingBar_RatingBarstarFill);
        this.starHalfDrawable = mTypedArray.getDrawable(R.styleable.RatingBar_RatingBarstarHalf);
        this.mClickable = mTypedArray.getBoolean(R.styleable.RatingBar_RatingBarclickable, false);
