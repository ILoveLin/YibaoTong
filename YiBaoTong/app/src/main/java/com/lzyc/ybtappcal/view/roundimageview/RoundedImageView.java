package com.lzyc.ybtappcal.view.roundimageview;
...
public class RoundedImageView extends ImageView {
  ...
  public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
    ...
    cornerRadius = a.getDimensionPixelSize(R.styleable.RoundedImageView2_corner_radius2, -1);
    borderWidth = a.getDimensionPixelSize(R.styleable.RoundedImageView2_border_width2, -1);
    ...
    borderColor = a.getColorStateList(R.styleable.RoundedImageView2_border_color2);
    if (borderColor == null) {
      borderColor = ColorStateList.valueOf(RoundedDrawable.DEFAULT_BORDER_COLOR);
    }

    mutateBackground = a.getBoolean(R.styleable.RoundedImageView2_mutate_background2, false);
    isOval = a.getBoolean(R.styleable.RoundedImageView2_oval2, false);
