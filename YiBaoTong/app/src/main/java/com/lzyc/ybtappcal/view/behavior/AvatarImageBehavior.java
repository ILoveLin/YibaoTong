package com.lzyc.ybtappcal.view.behavior;
...
public class AvatarImageBehavior extends CoordinatorLayout.Behavior<RoundedImageView> {
    ...
    private int mImgFinalXPosition;
    ...
    private void bindDimensions() {
        mAvatarMaxSize = mContext.getResources().getDimension(R.dimen.padding_80);
    }
    ...
    public boolean onDependentViewChanged(CoordinatorLayout parent, RoundedImageView child, View dependency) {
        Log.e("yanlc","onDependentViewChanged");
        // 初始化属性
        ...
        // X轴距离
        float distanceXToSubtract = ((mStartXPosition - mImgFinalXPosition)
     ...
     */
    private void shouldInitProperties(RoundedImageView child, View dependency) {
        ...
        // Toolbar中心
        if (mImgFinalXPosition == 0)
            mImgFinalXPosition = (dependency.getWidth() / 2);
        ...
        // Toolbar缩略图高度
        if (mFinalHeight == 0)
            mFinalHeight = mContext.getResources().getDimensionPixelOffset(R.dimen.padding_30);
