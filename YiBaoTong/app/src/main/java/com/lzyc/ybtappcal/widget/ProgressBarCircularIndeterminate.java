...
public class ProgressBarCircularIndeterminate extends CustomView {
        ...
        if (radius1 < getWidth() / 2) {
            ...
            if (cont >= 50) {
                ...
                radius2 = (radius2 >= getWidth() / 2
                        - DensityUtils.dpToPx(4, getResources())) ? (float) getWidth()
                        / 2 - DensityUtils.dpToPx(4, getResources())
                        : radius2 + 1;
            }
            ...
            if (radius2 >= getWidth() / 2
                    - DensityUtils.dpToPx(4, getResources()))
                cont++;
            if (radius2 >= getWidth() / 2)
    ...
    private void drawSecondAnimation(Canvas canvas) {
        ...
        temp.drawCircle(getWidth() / 2, getHeight() / 2, (getWidth() / 2)
                - DensityUtils.dpToPx(4, getResources()), transparentPaint);
