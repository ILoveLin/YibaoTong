...
public class WormAnimation extends AbsAnimation<AnimatorSet> {
    ...
    public WormAnimation( ValueAnimation.UpdateListener listener) {
        super(listener);
    }
    ...
    @SuppressLint("NewApi") public WormAnimation with(int fromValue, int toValue, int radius, boolean isRightSide) {
