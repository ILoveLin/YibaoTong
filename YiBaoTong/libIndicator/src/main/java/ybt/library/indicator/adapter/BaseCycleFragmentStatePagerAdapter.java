 ...
 */
public abstract class BaseCycleFragmentStatePagerAdapter<T> extends FragmentStatePagerAdapter implements BaseCycleAdapterInterface<T> {
    ...
    public BaseCycleFragmentStatePagerAdapter(final FragmentManager fm, final List<T> items) {
        super(fm);
        this.mItems = items;
    }
     ...
     */
    protected abstract Fragment getItemFragment(final T item, final int position);
