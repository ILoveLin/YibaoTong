...
public class LoopView extends View {
    ...
    private void initLoopView(Context context) {
        textSize = 0;
        colorGray = 0xff999999; //0xffafafaf;
        colorBlack = 0xff333333;// 0xff313131;
        colorGrayLight = 0xff999999; //0xffc5c5c5;
        l = 2.0F;
        isLoop = true;
        positon = -1;
        r = 9;
    ...
    private void e() {
        ...
        for (int i1 = 0; i1 < arrayList.size(); i1++) {
            paintB.getTextBounds("000000000000000", 0, "00000000000000".length(), rect);
            int j1 = rect.width();
...
//             canvas.drawLine(0.0F, o, v, o, paintC);
            ...
            while (j1 < r) {
                canvas.save();
                double d1 = ((double) ((float) (h * j1) * l - (float) j2) * Math.PI) / (double) t;
                float f1 = (float) (90D - (d1 / Math.PI) * 180D);
                if (f1 >= 90F || f1 <= -90F) {
                    canvas.restore();
                } else {
